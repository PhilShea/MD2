...
![Absolute value of the estimate vs. the standard error for 10,000 trials of length 50 regressions. Black points are failures, green are full length passes, and blue are shortened passes. The red line shows equality (estimate equals the standard error).](findlmlentst.PNG){#fig-regtest}
